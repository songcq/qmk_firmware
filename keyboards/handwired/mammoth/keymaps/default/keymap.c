...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
  {
   LAYOUT(
    ...
    W_(BSPC) , MO(1)     , C_(DEL)  , A_(ESC) ,                       A_(TAB) , C_(ENT)   , MO(2)     , W_(SPC)
	),
   LAYOUT(
    ...
    KC_LGUI  , NO__      , KC_LCTL  , KC_LALT ,                       KC_LALT , KC_LCTL   , MO(3)     , KC_LGUI
	),
   LAYOUT(
    ...
    KC_LGUI  , MO(3)     , KC_LCTL  , KC_LALT ,                       KC_LALT , KC_LCTL   , NO__      , KC_LGUI
	),
   LAYOUT(
